...
sysconfdir = "/Users/jvalen652/Desktop/Personal/learning-haskell/haskell-words/.stack-work/install/x86_64-osx/lts-9.14/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "haskell_words_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "haskell_words_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "haskell_words_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "haskell_words_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "haskell_words_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "haskell_words_sysconfdir") (\_ -> return sysconfdir)
